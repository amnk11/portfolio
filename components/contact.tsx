      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10 sm:mb-12">
            <a
              href={`mailto:${email}`}
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-3 bg-white text-black font-semibold text-base px-8 py-4 rounded-full hover:bg-zinc-100 transition-all duration-300 shadow-2xl group hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 px-6 py-4 rounded-full bg-[#16161f] border border-white/12 text-sm font-medium text-zinc-200 hover:text-white hover:border-white/25 transition-all active:scale-95"
            >
              {copied ? (
                <>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 pt-6 sm:pt-8 border-t border-white/10">
            <a
              href={`mailto:${email}`}
              className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-[#16161e] border border-white/10 text-xs font-mono text-zinc-300 hover:text-white hover:border-white/20 transition-all"
            >
